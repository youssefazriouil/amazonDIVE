 ...
 */
class DiveEntity extends \Dive\FrontBundle\Entity\DiveEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Dive\\FrontBundle\\Entity\\DiveEntity' . "\0" . 'id', '' . "\0" . 'Dive\\FrontBundle\\Entity\\DiveEntity' . "\0" . 'uid', '' . "\0" . 'Dive\\FrontBundle\\Entity\\DiveEntity' . "\0" . 'collections', 'comments');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DiveEntity $proxy) {
