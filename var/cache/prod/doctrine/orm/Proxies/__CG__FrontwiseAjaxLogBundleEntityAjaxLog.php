...
namespace Proxies\__CG__\Frontwise\AjaxLogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class AjaxLog extends \Frontwise\AjaxLogBundle\Entity\AjaxLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'id', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'action', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'user', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'ip', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'level', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'details', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'browser', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'createdAt', '' . "\0" . 'Frontwise\\AjaxLogBundle\\Entity\\AjaxLog' . "\0" . 'referer');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AjaxLog $proxy) {
    ...
    public function getLevelNames()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLevelNames', array());

        return parent::getLevelNames();
    }
    ...
    public function isValidLevel($level)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isValidLevel', array($level));
